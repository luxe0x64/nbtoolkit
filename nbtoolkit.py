...
class Toolkit:
    ...
    def display_menu(self):
        ...
        print("6. Update your system (Debian-based linux only)")
        print("7. Update your system (Arch linux only)")
        print("8. Program Update")
        print("9. Update your system (Fedora only)")
        print("10. Exit")
