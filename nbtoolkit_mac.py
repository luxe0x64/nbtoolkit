...
# Date: 10.02.2026 Update: Changed the way of converting the video and audio to make it suitable for macOS
...
# Mac version date: 10.02.26
# Another way of converting the video into audio or what's so ever.
            ...
            if self.convc == "Y" or self.convc == "y":
                ...
                if self.tconv == "mv":
                    ...
                    try:
                        ...
                        print("[*] Converting... ")
                        try:
                            os.system(f"ffmpeg -i '{self.tconv}' '{self.dconv}'")
                            print("[*] Converted. ")
                        except KeyboardInterrupt:
